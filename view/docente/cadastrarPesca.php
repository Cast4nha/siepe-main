            ...
            <div class="col s12 m12">
                <div class="card  z-depth-3">
                    <div class="card-content">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="nomePorto" class="validate" required aria-required="true" type="text" name="nomePorto" size="100" min="1" max="200" autocomplete="off"/>
                        ...
                        <div class="row" >
                            <table class="highlight centered responsive-table">
                                        ...
                                        <tbody id="acampForm">
                                            <tr>
                                                <td>
                                                    <input id="nomeAcampamento_0" class="validate" required aria-required="true" type="text" name="nomeAcampamento_0" size="100" min="1" max="200" autocomplete="off"/>
                                                </td>
                                                <td>
                                                    <input id="nomePesqueiro_0" class="validate" required aria-required="true" type="text" name="nomePesqueiro_0" size="100" min="1" max="200" autocomplete="off"/>
                                                </td>
                                                <td>
                                                    <select id="ambiente" name="ambiente_0[]" multiple>
                    ...
                    <div class="card-content" id='contabilizacao'>
                        ...
                        <div class="row">
                            <div class='input-field col s12 m3'>
                                <input id="valorGelo" class="validate dinheiro" type="text" name="valorGelo">
                                <label for="valorGelo">Gelo (R$):</label>
                            </div>
                            <div class='input-field col s12 m3'>
                                <input id="valorRancho" class="validate dinheiro" type="text" name="valorRancho">
                                <label for="valorRancho">Rancho (R$):</label>
                            </div>
                            <div class='input-field col s12 m3'>
                                <input id="valorCombustivel" class="validate dinheiro" type="text" name="valorCombustivel">
                                <label for="valorCombustivel">Combustível (R$):</label>
                            </div>
                            <div class='input-field col s12 m3'>
                                <input id="valorOutro" class="validate dinheiro" type="text" name="valorOutro">
                                <label for="valorOutro">Outros (R$):</label>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='input-field col s12 m4'>
                                <input id="qtdPescadores" class="validate" required aria-required="true" type="number" name="qtdPescadores" min="1" max="200"/>
                            ...
                            <div class='input-field col s12 m4'>
                                <input id="valorGasto" class="validate dinheiro" type="text" name="valorGasto" value="0,00"/>
                                <label class="active" for="valorGasto">Valor gasto / Custo (R$):</label>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='input-field col s12 m4'>
                                <input id="kgConsumido" class="validate" type="number" step="0.001" name="kgConsumido" min="1" max="9999" value="0.000"/>
                                <label for="kgConsumido">Total Consumido (Kg):</label>
                            </div>
                            <div class='input-field col s12 m4'>
                                <input id="kgVendido" class="validate" type="number" step="0.001" name="kgVendido" min="1" max="9999" value="0.000"/>
                                <label for="kgVendido">Total Vendido (Kg):</label>
                            </div>
                            <div class='input-field col s12 m4'>
                                <input id="valorVendido" class="validate dinheiro" type="text" name="valorVendido" value="0,00"/>
    ...
    $('#AdicionarPeixe').on('click', function () {
        ...
        if (idPeixe.val() != '0') {
            ...
            $('#peixeForm').append(
                ...
                '<select>' +
                '</td>' +
                '<td class="table-peixe"><input id="artepeixes' + idPeixe.val() + '" class="validate table-peixe" type="text" name="artepeixes' + idPeixe.val() + '" maxlength="3"/></td>' +
                ...
                '<td class="table-peixe"><input id="pesoVendido' + idPeixe.val() + '" class="validate table-peixe" type="number" step="0.001" name="pesoVendido' + idPeixe.val() + '" min="0" max="9999"/></td>' +
                '<td class="table-peixe"><input id="preco' + idPeixe.val() + '" class="validate dinheiro table-peixe" type="text" name="preco' + idPeixe.val() + '"/></td>' +
                '<td class="table-peixe"><input id="pesoConsumido' + idPeixe.val() + '" class="validate table-peixe" type="number" step="0.001" name="pesoConsumido' + idPeixe.val() + '" min="0" max="9999"/></td>' +

            ...
            <div class="col s12 m12">
                <div class="card  z-depth-3">
                    <div class="card-content">
                        ...
                        <div class="row">
                            <div class="input-field col s12 m6">
                                <input id="nomePorto" class="validate control-enabled" required aria-required="true" type="text" name="nomePorto" size="100" min="1" max="200" autocomplete="off" value="<?php echo $pesca->getNomePorto(); ?>" disabled/>
                    ...
                    <div class="card-content">
                        ...
                        <div class="row" >
                            <table class="highlight centered responsive-table">
                                ...
                                <tr>
                                    <td>
                                        <input id="nomeAcampamento_<?php echo $acam; ?>" class="validate control-enabled" required aria-required="true" type="text" name="nomeAcampamento_<?php echo $acam; ?>" size="100" min="1" max="200" autocomplete="off" value="<?php echo $ac->getNome(); ?>" disabled/>
                                    </td>
                                    <td>
                        ...
                        <div class="row">
                            <table class="highlight centered responsive-table">
                                ...
                                <?php foreach ($pescaInstrumento as $pescaInst) {
                                    ...
                                    $malhadeiras = [];
                                    if ($instr->getDescricao() == 'Malhadeira')
                    ...
                    <div class="card-content" id='peixesColetados'>
                                ...
                                <select id="especiePeixe" name="especiePeixe" class="control-enabled" disabled>
                                    ...
                                    <?php foreach ($especies as $especie) {
                                        ...
                                        <option id='esp<?php echo $especie->getId(); ?>'
                                                value='<?php echo $especie->getId(); ?>' <?php if ($selecionado) echo 'disabled'; ?>><?php echo $especie->getNomePopular() . ' (' . $especie->getGenero() . ' ' . $especie->getEspecie() . ' )'; ?></option>
                                    <?php } ?>
                                </select>
                        ...
                        <div class='row'>
                            <table class="highlight centered responsive-table">
                                ...
                                <tbody id="peixeForm">
                                <?php foreach ($pescaEspecie as $pescaEsp) {
                                    ...
                                    <tr id="<?php echo $pescaEsp->getIdespecie(); ?>">
                                        <td class="table-peixe table-peixe-esp">
                                            <select name="peixes[]" disabled>
                                                <option id="<?php echo $pescaEsp->getIdespecie(); ?>"
                                                        value='<?php echo $pescaEsp->getIdespecie(); ?>'><?php echo $especie->getNomepopular() . ' (' . $especie->getGenero() . ' ' . $especie->getEspecie() . ')'; ?></option>
                                            </select>
                                        </td>
                                        <td class="table-peixe"><input
                                                    ...
                                                    name="artepeixes<?php echo $pescaEsp->getIdespecie(); ?>" disabled/></td>

                                        <td>
                                            <div class="table-peixe">
                                                <select name="tipoMedicao<?=$pescaEsp->getIdespecie()?>" id="tipoMedicao<?php echo $pescaEsp->getIdespecie(); ?>" class="control-enabled" disabled>
                                        ...
                                        <td class="table-peixe">
                                            <input id="fator<?php echo $pescaEsp->getIdespecie(); ?>" value="<?php echo str_replace('.', ',', $pescaEsp->getFator()); ?>"
                                                class="dinheiro table-peixe control-enabled" type="text" name="fator<?php echo $pescaEsp->getIdespecie(); ?>" min="0" disabled/>
                                        </td>
                                        <td class="table-peixe validate">
                                            <input id="qtdvendida<?php echo $pescaEsp->getIdespecie(); ?>" value="<?php echo $pescaEsp->getQtdvendida(); ?>" class="table-peixe control-enabled validate"
                                                    type="number" step="0.001" name="qtdvendida<?php echo $pescaEsp->getIdespecie(); ?>" min="0" max="2000" disabled/>
                                        </td>
                                        <td class="table-peixe">
                                            <input id="preco<?php echo $pescaEsp->getIdespecie(); ?>" value="<?php echo str_replace('.', ',', $pescaEsp->getPreco()); ?>"
                                                   class="dinheiro table-peixe control-enabled" type="text" name="preco<?php echo $pescaEsp->getIdespecie(); ?>" disabled/>
                                        </td>
                                        <td class="table-peixe validate">
                                            <input id="qtdconsumida<?php echo $pescaEsp->getIdespecie(); ?>" value="<?php echo $pescaEsp->getQtdconsumida(); ?>" class="table-peixe control-enabled validate"
                                                   type="number" step="0.001" name="qtdconsumida<?php echo $pescaEsp->getIdespecie(); ?>" min="0" max="2000" disabled/>
                                        </td>
                                        <td>
                                            <button class="btn waves-effect waves-light red control-enabled tooltipped"
                        ...
                        <div class="row">
                            <div class='input-field col s12 m3'>
                                <input id="valorGelo" value="<?php echo str_replace('.', ',', $pesca->getGelo()); ?>"
                                       class="dinheiro control-enabled" type="text" name="valorGelo" disabled>
                                <label for="valorGelo">Gelo (R$):</label>
                            </div>
                            <div class='input-field col s12 m3'>
                                <input id="valorRancho"
                                       value="<?php echo str_replace('.', ',', $pesca->getAlimento()); ?>"
                                       class="dinheiro control-enabled" type="text" name="valorRancho" disabled>
                                <label for="valorRancho">Rancho (R$):</label>
                            </div>
                            <div class='input-field col s12 m3'>
                                <input id="valorCombustivel"
                                       value="<?php echo str_replace('.', ',', $pesca->getCombustivel()); ?>"
                                       class="dinheiro control-enabled" type="text" name="valorCombustivel" disabled>
                                <label for="valorCombustivel">Combustível (R$):</label>
                            </div>
                            <div class='input-field col s12 m3'>
                                <input id="valorOutro"
                                       value="<?php echo str_replace('.', ',', $pesca->getOutrosGastos()); ?>"
                                       class="dinheiro control-enabled" type="text" name="valorOutro" disabled>
                                <label for="valorOutro">Outros (R$):</label>
                            </div>
                        </div>
                        <div class='row'>
                            ...
                            <div class='input-field col s12 m4'>
                                <input id="valorGasto"
                                       ...
                                       class="dinheiro control-enabled" type="text" name="valorGasto" disabled/>
                                <label class="active" for="valorGasto">Valor gasto / Custo (R$):</label>
                            </div>
                        </div>
                        <div class='row'>
                            <div class='input-field col s12 m4'>
                            ...
                            <div class='input-field col s12 m4'>
                                <input id="valorVendido"
                                       ...
                                       class="dinheiro control-enabled" type="text" name="valorVendido" disabled/>
                                <label class="active" for="valorVendido">Valor arrecadado (R$):</label>
                            </div>
                        </div>
                    </div>
                </div>
...
<script type='text/javascript'>
    ...
    $('#AdicionarInstrumento').on('click', function () {
        ...
        if (idInstrumento.val() != '0') {
            ...
            var optMalhadeira = idInstrumento.text() == 'Malhadeira' ? '' : 'disabled';
            var optQtd = idInstrumento.text() == 'Espinhel' || idInstrumento.text() == 'Malhadeira' ? '' : 'disabled';
            $('#instrForm').append(
                ...
                '<td class="table-instr">' +
                "<select name='tipoMalha[]' id='tipoMalha' multiple " + optMalhadeira + ">" +
    ...
    $('#AdicionarPeixe').on('click', function () {
        ...
        if (idPeixe.val() != '0') {
            ...
            $('#peixeForm').append(
                ...
                '<td class="table-peixe table-peixe-esp">' +
                '<select name="peixes[]" disabled>' +
                '<option value="' + idPeixe.val() + '" type="text">' + idPeixe.text() + '</option>' +
                '<select>' +
                '</td>' +
                '<td class="table-peixe"><input id="artepeixes' + idPeixe.val() + '" class="validate table-peixe" type="text" name="artepeixes' + idPeixe.val() + '" maxlength="10"/></td>' +
                '<td><div class="table-peixe">' +
                '<select name="tipoMedicao' + idPeixe.val() +'" id="tipoMedicao' + idPeixe.val() +'">' +
                <?php foreach (TipoMedicao::TIPOS as $tipo) {
                    echo '\'<option value="' . $tipo['id'] . '">' . $tipo['descricao'] . '</option>\'+';
                }?>
                '</select>'+
                '</div></td>' +
                '<td class="table-peixe"><input id="fator' + idPeixe.val() + '" class="validate dinheiro table-peixe" type="text" name="fator' + idPeixe.val() + '"/></td>' +
                '<td class="table-peixe"><input id="pesovendido' + idPeixe.val() + '" class="validate table-peixe" type="number" step="0.001" name="pesovendido' + idPeixe.val() + '" min="0" max="999"/></td>' +
                '<td class="table-peixe"><input id="preco' + idPeixe.val() + '" class="validate dinheiro table-peixe" type="text" name="preco' + idPeixe.val() + '"/></td>' +
                '<td class="table-peixe"><input id="pesoconsumido' + idPeixe.val() + '" class="validate table-peixe" type="number" step="0.001" name="pesoconsumido' + idPeixe.val() + '" min="0" max="999"/></td>' +
                '<td><button class="btn waves-effect waves-light red tooltipped" data-tooltip="Clique para deletar a espécie ' + idPeixe.text() + ' da pesca" type="button" id="removerPeixe" name="removerPeixe" onclick="removePeixe(' + idPeixe.val() + ')"><i class="material-icons">delete</i></button></td>' +
                '</tr>'
            );
            $('.dinheiro').maskMoney({
                thousands: '.',
